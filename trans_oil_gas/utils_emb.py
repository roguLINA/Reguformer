...
def calculate_metrics_for_final(
    ...
    return acc, roc_auc, pr_auc, precision, recall, f1
...
def train_test_linear_classifier(
    ...
    acc, roc_auc, pr_auc, precision, recall, f1 = calculate_metrics_for_final(
    ...
    return model, logger, (acc, roc_auc, pr_auc, precision, recall, f1)
